...
大規模な話になりましたが, これで OpenFlow や SDN の導入編はおしまいです. 続く実践編は OpenFlow プログラミングを手軽に始めてみようというチュートリアルとなっています. 職場や自宅のような中小規模ネットワークでもすぐに試せる実用的なコードを通じて, 「OpenFlow ってどんな仕様？」「どうやってプログラムを書けばいいの？」という疑問に答えていきます. ネットワークの基礎から説明しますので, 普通のプログラマもすんなりと理解できるはずです.
